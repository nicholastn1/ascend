---
title: "Using the API"
description: "Learn how to create API keys and authenticate requests to the Ascend API"
---
...
<Steps>
  ...
  <Step title="Authenticate requests with x-api-key">
    ...
    <Info>
      If you're self-hosting, replace <code>/</code> with your instance URL. The API is served under <code>/api/openapi</code>.
    </Info>

    ```bash
    curl "//api/openapi/resumes" \
