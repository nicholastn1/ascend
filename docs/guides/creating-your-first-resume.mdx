...
description: "Learn how to create your first resume in Ascend, set a name and slug, and open it in the builder."
---

<Steps>
  <Step title="Log in to your account">
    Head over to [/](/) and log in with your account credentials.
  ...
  <Step title="Review (or edit) the slug">
    ...
    <Warning>
      If you choose to publicly share your resume, it will be accessible at `//{username}/{slug}`.
    </Warning>
  </Step>
