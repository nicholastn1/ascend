---
title: "Introduction"
description: "Welcome to the documentation for Ascend, a free and open-source resume builder that simplifies the process of creating, updating, and sharing your resume."
---

<Frame>
  <img src="/images/getting-started/banner.webp" alt="Ascend Banner"  />
</Frame>

## What is Ascend?

**Ascend** is a free and open-source resume builder designed to simplify the process of creating, updating, and sharing your professional resume. Built with privacy as a core principle, it gives you complete control over your data while providing a powerful, modern experience.
...
<Frame>
  <img src="/images/getting-started/infographic.webp" alt="An infographic of the major features of Ascend" />
</Frame>

<AccordionGroup>
  <Accordion title="Completely Free & Open Source" icon="code-branch">
    Ascend is licensed under MIT. You can use it for free, modify it, and even host your own instance. The entire codebase is available on [GitHub](#).
  </Accordion>
  ...
  <Accordion title="Multi-language Support" icon="globe">
    Ascend supports multiple languages, making it accessible to users worldwide. Contribute translations to help us reach more people.
  </Accordion>
  ...
  <Accordion title="Self-hosting Ready" icon="server">
    Deploy your own instance of Ascend using Docker. Keep complete control over your data and infrastructure.
  </Accordion>
</AccordionGroup>

## Getting Started

Whether you want to use our hosted version or run your own instance, Ascend has got you covered.
...
<CardGroup cols={2}>
  ...
  >
    Set up a local development environment to contribute or customize Ascend.
  </Card>
</CardGroup>

## Tech Stack

Ascend is built with modern web technologies:
...
<CardGroup cols={2}>
  ...
  <Card title="Sponsor" icon="heart" href="#">
    Support the development and long-term sustainability of Ascend.
  </Card>
</CardGroup>

<Note>
  **Need help?** Feel free to reach out via [email](mailto:noreply@localhost) or open an issue on GitHub.
</Note>
