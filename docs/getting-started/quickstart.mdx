---
title: "Quickstart"
description: "Get started with Ascend in minutes — use our hosted version or deploy your own instance"
---

## Options

Ascend offers flexibility in how you want to use it. Choose the option that best fits your needs:
...
The easiest way to use Ascend is through our cloud version at [localhost](/). **This service is completely free and will always remain free.**

<Steps>
  <Step title="Create an Account">
    Visit [localhost](/) and sign up for free using your email, or sign in with your GitHub or Google account.
  </Step>
...
For users who prefer complete control over their data, you can deploy Ascend on your own infrastructure using Docker.
...
<Steps>
  ...
  <Step title="Start the Services">
    ...
    - **Ascend** — The main application
  </Step>
  
  <Step title="Access Your Instance">
    Once all services are running, access your Ascend instance at:
...
| `app` | 3000 | The main Ascend application |
...
<CardGroup cols={2}>
  ...
  >
    Set up a development environment to contribute or customize Ascend.
  </Card>
  <Card
...
<Note>
  **Having trouble?** Check our [GitHub Issues](#) or reach out via [email](mailto:noreply@localhost).
</Note>
