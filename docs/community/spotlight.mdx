---
title: "Spotlight"
description: "A showcase of articles, videos, and social media posts from the Ascend community"
---

<Note>
Have you created something that makes use of Ascend, or spread the word about it in your own way? I'd love to feature it here! Send me an email at [noreply@localhost](mailto:noreply@localhost) and I'll make sure to add it to this page.
</Note>
...
A collection of blog posts and articles written by the community about Ascend.
...
Posts and threads from social media platforms sharing experiences with Ascend.
