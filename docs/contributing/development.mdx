...
description: "Set up a local development environment for Ascend"
---
...
This guide walks you through setting up Ascend for local development. Whether you're contributing to the project or customizing it for your needs, these steps will get you up and running.
...
<Steps>
  ...
  <Step title="Start the Development Server">
    ...
    Your local Ascend instance will be available at [http://localhost:3000](http://localhost:3000).
  </Step>
</Steps>
...
Ascend uses [Lingui](https://lingui.dev/) for internationalization.
