...
description: "Help translate Ascend into your language using Crowdin"
---

Ascend is used by people all around the world, and translations help make the app accessible to everyone. If you speak a language other than English, you can help by contributing translations.

---

## How Translations Work

Ascend uses [Crowdin](https://crowdin.com/) as its localization management platform. Crowdin provides a user-friendly interface where translators can contribute translations without needing to write code or work with files directly.

<Info>
  The Ascend Crowdin project is available at [https://crowdin.com/project/ascend](https://crowdin.com/project/ascend).
</Info>
...
<Steps>
  ...
  <Step title="Join the Ascend Project">
    Navigate to the [Ascend project on Crowdin](https://crowdin.com/project/ascend) and click **Join** to become a contributor.
  </Step>
...
<Warning>
  Before requesting a new language, please check if it's already available in the [Crowdin project](https://crowdin.com/project/ascend).
</Warning>
...
4. Title it something like: "Add [Language Name] to Ascend"
...
Translations submitted on Crowdin are synced to the codebase periodically. Once merged, they will be included in the next release of Ascend.
...
Thank you for helping make Ascend accessible to users worldwide!
