...
description: "Understand the architecture and codebase structure of Ascend"
---

This guide provides a comprehensive overview of Ascend's architecture and codebase structure, helping you understand how different parts of the application work together.

---

## Tech Stack Overview

Ascend is built with a modern, type-safe stack:
...
**Diagram:** This flow shows data and control flow between the main architectural layers of Ascend.
