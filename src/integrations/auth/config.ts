		...
		emailVerification: {
			...
			sendVerificationEmail: async ({ user, url }) => {
				await sendEmail({
					...
					text: `You recently signed up for an account on Ascend.\n\nTo verify your email, please visit the following URL:\n${url}`,
				});
			},
		},
			...
			changeEmail: {
				...
				sendChangeEmailConfirmation: async ({ user, newEmail, url }) => {
					await sendEmail({
						...
						text: `You recently requested to change your email on Ascend from ${user.email} to ${newEmail}.\n\nTo verify this change, please visit the following URL:\n${url}\n\nIf you did not request this change, please ignore this email.`,
					});
				},
			},
			additionalFields: {
